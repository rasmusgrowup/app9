...
import WebUpper from '../../public/daniel_wagner_web.jpg'
    ...
    <>
      <section className={css.page}>
        <div className={css.upper}>
          <div className={css.titleWrapper}><h1 className={`${css.danielTitel} ${css.pageTitel}`} ref={titleRef}>Daniel Wagner</h1></div>
